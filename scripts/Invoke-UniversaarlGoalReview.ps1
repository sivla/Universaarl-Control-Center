...
if ($twinState.head) {
    ...
    $twinSnapshotCatalog = Read-RequiredGoalText -Repository $twinRoot -Commit $twinState.head -Path 'src/server/snapshot-catalog.ts' -Findings $twinFindings -Code 'GOAL-TW-ARTIFACT'
}
